...
export default function CartButton() {
  ...
  return (
    <Link
      ...
      className="relative inline-flex h-12 w-12 items-center justify-center rounded-full bg-[#0076ff] text-[#030712] shadow-[0_0_15px_rgba(0,245,255,0.55)] transition duration-200 hover:bg-[#0076ff] hover:text-white focus:outline-none focus:ring-2 focus:ring-[#0076ff]/50 focus:ring-offset-2 focus:ring-offset-[#030712]"
    >
